...
echo "docker build -t ${REGION}-docker.pkg.dev/${PROJECT_ID}/${REPOSITORY_NAME}/jplaw2epub-api:latest ."
echo ""
echo "# Push the image:"
echo "docker push ${REGION}-docker.pkg.dev/${PROJECT_ID}/${REPOSITORY_NAME}/jplaw2epub-api:latest"
echo ""
echo "# Pull the image:"
echo "docker pull ${REGION}-docker.pkg.dev/${PROJECT_ID}/${REPOSITORY_NAME}/jplaw2epub-api:latest"
echo ""
